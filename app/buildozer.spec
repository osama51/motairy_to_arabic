...
title = Motairy to Arabic

# (str) Package name
package.name = motairy2arabic

# (str) Package domain (needed for android/ios packaging)
package.domain = org.toddler.appname

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (let empty to include all the files)
source.include_exts = py,ui,png,jpg,kv,atlas
...
requirements = python3,kivy==2.3.0, kivymd, certifi>=2018.4.16, pyjnius==1.5.0, Cython==0.29.10
